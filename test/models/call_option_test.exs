defmodule Ragnar.CallOptionTest do
  ...
  @valid_attrs %{last_update: %{day: 17, hour: 14, min: 0, month: 4, sec: 0, year: 2010}, price: "120.5", serie_symbol: "some content", stock_symbol: "some content", strike: "120.5", symbol: "some content", trades: 42}
  @invalid_attrs %{}
