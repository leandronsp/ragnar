defmodule RagnarWeb.CallOptionView do
  use RagnarWeb, :view

  def render("call_options.json", %{call_options: call_options}) do
    render_many(call_options, RagnarWeb.CallOptionView, "call_option.json")
  end

  def render("call_options_evaluated.json", %{call_options: call_options}) do
    render_many(call_options, RagnarWeb.CallOptionView, "call_option_evaluated.json")
  end
